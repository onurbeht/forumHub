...
public class UsuarioControllerTest {
        ...
        void setUp() {
                ...
                usuario = Usuario.builder().id(UUID.randomUUID().toString()).username("username").password("password")
                                .build();
        ...
        void UsuarioController_create_returnUsuario() throws JsonProcessingException, Exception {
                ...
                createUsuarioResponseDto = new CreateUsuarioResponseDto(usuario.getId(),
                                createUsuarioRequestDto.username());
        ...
        void UsuarioController_create_errorCase1() throws JsonProcessingException, Exception {
                ...
                when(usuarioService.findByUsername(createUsuarioRequestDto.username()))
        ...
        void UsuarioController_login_returnTokenJwt() throws JsonProcessingException,
                ...
                when(usuarioService.login(loginRequestDto, usuario)).thenReturn("Token jwt ...");
                ...
                verify(usuarioService, times(1)).login(loginRequestDto, usuario);
                verifyNoMoreInteractions(usuarioService);
        }
        ...
        void UsuarioController_login_errorCase2() throws JsonProcessingException, Exception {
                ...
                when(usuarioService.findByUsername(loginRequestDto.username())).thenReturn(Optional.of(usuario));
                when(usuarioService.login(loginRequestDto, usuario))
        ...
        void UsuarioController_currentUsuario_returnUsuarioResponseDto() throws JsonProcessingException, Exception {
                ...
                response
                                ...
                                .andExpect(jsonPath("$.respostas.length()")
                                                .value(usuarioResponseDto.respostas().size()));
        }
}
